...
from bio.utils import concate_aspect_and_opinion, save_examples, save_dict, decoding
...
if __name__ == "__main__":
    ...
    parser.add_argument("--doccano_file", type=str, default="./data/doccano.json",
                        help="The doccano file exported from doccano platform.")
    parser.add_argument("--save_ext_dir", type=str, default="./data/ext_data1",
                        help="The path of ext data that you wanna save.")
    parser.add_argument("--save_cls_dir", type=str, default="./data/cls_data1",
